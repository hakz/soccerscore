<div class="tabbable">
	<div class="title"><strong>LIST ORDER YANG SEDANG DIKIRIM</strong><?php echo anchor('news/local/123', '<i class="icon-plus" style="float: right;"></i>', 'title="Tambah Item"')?></div>
	</br>
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align: center"><button class="btn btn-warning" type="button">Sending</button></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
